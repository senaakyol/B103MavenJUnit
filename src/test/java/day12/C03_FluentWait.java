...
public class C03_FluentWait extends TestBase {
    ...
    public void fluentWaitTest(){
        ...
        Wait<WebDriver> wait = new FluentWait<>(driver)
                ...
                .ignoring(NoSuchMethodException.class);//EXCEPTION HANDLE ET.ZORUNLU DEGIL

        //   2. wait objesini kullanarak bekleme problemini cozmeye calis
        WebElement helloWorldElement= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='start']//button")));
